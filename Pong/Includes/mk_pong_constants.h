...
*
* @file mk_pong_constants.h
* @brief Déclaration des constantes dédiées au module 'Pong'.
* @date 11 août 2023
*
*/

#ifndef MK_PONG_CONSTANTS_H
#define MK_PONG_CONSTANTS_H

/**
 * @def K_MK_PONG_STACK_SIZE
 * @brief Définition de la taille de la stack de l'application 'Pong'. \n
 *        Cette constante peut être modifiée par l'utilisateur.
 */

#define K_MK_PONG_STACK_SIZE 1024
...
#define K_MK_PONG_FIELD_FONT_HEIGHT 49
...
/**
 * @def K_MK_PONG_NET_WIDTH
 * @brief Définition de la largeur du filet [en pxl].
 */

#define K_MK_PONG_NET_WIDTH 6

/**
 * @def K_MK_PONG_NET_HEIGHT
 * @brief Définition de la hauteur des segments du filet [en pxl].
 */

#define K_MK_PONG_NET_HEIGHT 16

/**
 * @def K_MK_PONG_NET_OFFSET
 * @brief Définition de l'offset du premier segment du filet [en pxl].
 *        Elle est définie selon l'extrémité haute de l'écran.
 */

#define K_MK_PONG_NET_OFFSET 8
...
/**
 * @def K_MK_PONG_BORDER_HEIGHT
 * @brief Définition de la hauteur de la bordure [en pxl].
 */

#define K_MK_PONG_BORDER_HEIGHT 8
...
/**
 * @def K_MK_PONG_RACKET_WIDTH
 * @brief Définition de la largeur des rackettes [en pxl].
 */

#define K_MK_PONG_RACKET_WIDTH 10
 ...
 * @brief Définition de l'offset des raquettes [en pxl].
 *        Elle est définie selon les extrémités droites et gauches
 *        de l'écran.
 */

#define K_MK_PONG_RACKET_OFFSET 24

/**
 * @def K_MK_PONG_RACKET_STEP
 * @brief Définition du nombre de pixels ajoutés ou retranchés
 ...
 * @brief Définition de la valeur du seuil déclenchant l'actualisation
 *        de la position de la raquette du J2.
 */

#define K_MK_PONG_RACKET_THRESHOLD 30
...
/**
 * @def K_MK_PONG_DEAD_ZONE_HEIGHT
...
/**
 * @def K_MK_PONG_BALL_WIDTH
 * @brief Définition de la largeur de la balle [en pxl].
 */

#define K_MK_PONG_BALL_WIDTH 10

/**
 * @def K_MK_PONG_BALL_INITIAL_DX
 * @brief Définition de la variation initiale de la balle sur
 *        l'axe 'x' [en pxl/frame].
 *        Un tirage aléatoire est effectué pour déterminer le
 *        signe de la variation.
 */

#define K_MK_PONG_BALL_INITIAL_DX 2

/**
 * @def K_MK_PONG_BALL_MAX_INITIAL_DY
 * @brief Définition de la variation initiale maximale de la balle sur
 *        l'axe 'y' [en pxl/frame]. Elle varie de [0 à K_MK_PONG_BALL_MAX_INITIAL_DY].
 */

#define K_MK_PONG_BALL_MAX_INITIAL_DY 2

/**
 * @def K_MK_PONG_BALL_INITIAL_SPEED
 * @brief Définition de la vitesse initiale de la balle.
 */

#define K_MK_PONG_BALL_INITIAL_SPEED 2.3f

/**
 * @def K_MK_PONG_BALL_MAX_SPEED
...
/**
 * @def K_MK_PONG_MAX_SCORE
 * @brief Définition du nombre de points nécessaires pour
 *        gagner une partie.
 */

#define K_MK_PONG_MAX_SCORE 10
...
/**
 * @def K_MK_PONG_GAME_START
 * @brief Définition de la valeur d'une valeur permettant de déclencher
 *        une partie.
 */

#define K_MK_PONG_GAME_START 1

/**
 * @def K_MK_PONG_GAME_STOP
 * @brief Définition de la valeur d'une valeur permettant de d'arrêter
 *        une partie.
 */

#define K_MK_PONG_GAME_STOP 0
...
/**
 * @def K_MK_PONG_MODE_PLAYER
 * @brief Définition de la valeur permettant d'activer une partie jouée
 *        par 1 joueur et 1 bot.
 */

#define K_MK_PONG_MODE_PLAYER 1

/**
 * @def K_MK_PONG_MODE_DEMO
 * @brief Définition de la valeur permettant d'activer une partie jouée
 *        par 2 bots.
 */

#define K_MK_PONG_MODE_DEMO 0
