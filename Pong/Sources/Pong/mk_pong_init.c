...
T_mkCode mk_pong_init ( T_mkPongApplication* p_pong )
{
   ...
   mk_textField_setPosition ( &p_pong->background.scoreJ1, K_MK_PONG_FIELD_SCORE_J1_POSITION_X, K_MK_PONG_FIELD_SCORE_J1_POSITION_Y );
   mk_textField_setDimension ( &p_pong->background.scoreJ1, K_MK_PONG_FIELD_SCORE_J1_WIDTH, K_MK_PONG_FIELD_SCORE_J1_HEIGHT );
   ...
   mk_textField_setPosition ( &p_pong->background.scoreJ2, K_MK_PONG_FIELD_SCORE_J2_POSITION_X, K_MK_PONG_FIELD_SCORE_J2_POSITION_Y );
   mk_textField_setDimension ( &p_pong->background.scoreJ2, K_MK_PONG_FIELD_SCORE_J2_WIDTH, K_MK_PONG_FIELD_SCORE_J2_HEIGHT );
   ...
   mk_textField_setPosition ( &p_pong->background.buttonStart, K_MK_PONG_FIELD_MAIN_MENU_POSITION_X, K_MK_PONG_FIELD_MAIN_MENU_POSITION_Y );
   mk_textField_setDimension ( &p_pong->background.buttonStart, K_MK_PONG_FIELD_MAIN_MENU_BUTTON_WIDTH, K_MK_PONG_FIELD_MAIN_MENU_BUTTON_HEIGHT );
   ...
   mk_textField_setPosition ( &p_pong->background.buttonQuit, K_MK_PONG_FIELD_MAIN_MENU_POSITION_X,
                              K_MK_PONG_FIELD_MAIN_MENU_POSITION_Y + K_MK_PONG_FIELD_MAIN_MENU_BUTTON_HEIGHT + K_MK_PONG_FIELD_MAIN_MENU_BUTTON_GAP );
   mk_textField_setDimension ( &p_pong->background.buttonQuit, K_MK_PONG_FIELD_MAIN_MENU_BUTTON_WIDTH, K_MK_PONG_FIELD_MAIN_MENU_BUTTON_HEIGHT );
